...
'''
    ...
    # GGUF through as if it were qwen3 so the config loads. The GGUF tensor
    # name map for qwen3 works because the base transformer structure is the
    # same; the hybrid DeltaNet specifics are resolved by vLLM itself.
